<?php return array (
  ...
  array (
		...
		'list_activity' => '活动列表模板',	
                                'list_teacher' => '讲师列表模板',	
                                'list_jidi' => '基地列表模板',	
                                'list_mini' => 'self迷你基地列表模板', 
  ),
  ...
  array (
	    ...
	    'show_activity' => '自定义活动内容页模板', 
                    'show_teacher' => '自定义讲师内容页模板', 
                    'show_jidi' => '自定义基地内容页模板', 
                    'show_mini' => 'self迷你基地内容页模板', 
  ) 
